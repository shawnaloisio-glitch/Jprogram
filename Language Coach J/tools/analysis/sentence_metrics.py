...
Isolated copy, adapted from Jprogram's Analysis/sentence_metrics.py
(2026-08-07) - not a live import. See corpus_loader.py for the boundary
note. No adaptation needed - this module has no lemma/surface grouping
question at all (pure per-sentence structural stats).
